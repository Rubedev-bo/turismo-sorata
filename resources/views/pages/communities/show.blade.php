...
@section('title', $community->nombre ?? 'Comunidad')

@section('content')
<section class="community-hero" style="padding:60px 0;">
    <div class="container">
        <h1 data-aos="fade-up">{{ $community->nombre }}</h1>
        <p data-aos="fade-up" data-aos-delay="100">{{ $community->descripcion }}</p>
        <div class="community-experiences" style="margin-top:24px;">
            ...
            <div class="experiences-grid" style="margin-top:16px;">
                @foreach($community->experiencias as $exp)
